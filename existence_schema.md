...
| `productoReferencia`                            | productoReferencia | Metadatos para identificar producto y fuente de datos                                    | Sí          | Object          | CT_API_Publica / tbl_existenciasHistorial |
| `existenceId`                            | productoReferencia.existenciaId| Identificador único del documento del cual se extrajo la información                                      | Sí          |  ObjectId       | CT_API_Publica / tbl_existencias |
| `productId`                            |productoReferencia.codigo | Código identificador de producto                                       | Sí          | Texto / String          | CT_API_Publica / tbl_existencias |
