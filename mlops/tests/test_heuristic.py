...
rows = [["product1",datetime.datetime(2025,2,5),1,"client1"],
        ["product1",datetime.datetime(2025,1,2),2,"client2"],
        ["product1",datetime.datetime(2024,12,1),2,"client3"],
        ["product1",datetime.datetime(2024,12,1),1,"client1"],
        ["product1",datetime.datetime(2024,12,4),1,"client2"],
        ["product1",datetime.datetime(2024,12,3),6,"unknown"],
        ["product1",datetime.datetime(2024,11,3),1,"unknown"],
        ["product1",datetime.datetime(2024,11,3),2,"client3"],
        ["product1",datetime.datetime(2024,11,3),1,"unknown"],
        ["product1",datetime.datetime(2024,10,2),1,"unknown"],
        ["product1",datetime.datetime(2024,9,1),14,"unknown"],

    ]+[ ["product2",datetime.datetime(2025,2,5),4,"client2"],
        ["product2",datetime.datetime(2025,2,5),9,"unknown"],
        ["product2",datetime.datetime(2025,1,2),13,"client1"],
        ["product2",datetime.datetime(2025,1,2),25,"unknown"],
        ["product2",datetime.datetime(2024,12,1),6,"client3"],
        ["product2",datetime.datetime(2024,12,1),6,"client1"],
        ["product2",datetime.datetime(2024,12,4),6,"client2"],
...
def test_get_client_sales():
    mask = dataset["productId"]=="product1"
    model.fit(dataset[mask])
    test_sales1 = pd.DataFrame()
    assert model.client_sales.equals() 
