...
| ------------------------------------- | ------------------------------------------------------------------ | ------------------------------- |------------------------------- |
| **client_id**(Key)                    | Llave identificadora de clientes                                   |   VARCHAR                       | DWH/Tabla de clientes          |
...
| **Nombre de variable**                | **Descripción**                                                             | **Formato**                     | **Fuentes**                    |
| ------------------------------------- | --------------------------------------------------------------------------- | ------------------------------- |------------------------------- |
| **product_id**(Primary Key)           | Llave identificadora de productos                                           |   VARCHAR                       | DWH/Tabla de productos         |
| **category_id**(Foreign Key)          | Llave identificadora de categorías                                          |   VARCHAR                       | ctonline/ Tabla de productos        |
...
| **Nombre de variable**                | **Descripción**                                                    | **Formato**                     | **Fuentes**                    |
| ------------------------------------- | ------------------------------------------------------------------ | ------------------------------- |------------------------------- |
| **category_id**(Primary Key)          | Llave identificadora de categoría                                  |   Integer                       | ctonline/ Tabla de categorías  |
| **parent_id**(Foreign Key)            | Llave identificadora de categoría padre                            |   Integer                       | ctonline/ Tabla de productos   |
...
| **Nombre de variable**                | **Descripción**                                                    | **Formato**                     | **Fuentes**                    |
| ------------------------------------- | ------------------------------------------------------------------ | ------------------------------- |------------------------------- |
| **storage_id**(Key)                   | Llave identificadora de almacen                                    |   VARCHAR                       | CT_API_Publica/Tabla de almacenes.nemonico         |
| **branch**                            | Ciudad de donde origina el almacen                                 |   VARCHAR                       | CT_API_Publica/Tabla de almacenes.sucursal           |
| **branch_id**                         |  Llave identificadora de sucursal                                  |   VARCHAR                       | CT_API_Publica/Tabla de almacenes.homoclave          |
| **state**                             | Estado de donde originan los clientes                              |   VARCHAR                       | states.json         |
